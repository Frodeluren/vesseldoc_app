                            ...
                            Container(
                              ...
                              child: DropdownButtonHideUnderline(
                                child: DropdownButton(
                                  ...
                                  items: [
                                    DropdownMenuItem(
                                        value: "1", child: Text("Workers")),
                                    DropdownMenuItem(
                                        value: "2", child: Text("Supervisors")),
                                    DropdownMenuItem(
                                        value: "3", child: Text("All")),
          ...
          children: <Widget>[
            Container(
              padding: EdgeInsets.only(
                  left: 10, top: MediaQuery.of(context).size.width * 0.01),
              child: Container(
                decoration: new BoxDecoration(
                  boxShadow: [
                    BoxShadow(
                        ...
                        child: DropdownButtonHideUnderline(
                          child: DropdownButton(
                            ...
                            items: [
                              ...
                              DropdownMenuItem(
                                  value: "TextInput", child: Text("Textinput"))
                            ],
                            onChanged: (value) {
                              setState(() {
                                fieldType = value;
                      ...
                      child: Container(
                        child: ReorderableListView(
                            ...
                            onReorder: (oldIndex, newIndex) {
                              if (newIndex > tools.itemsInDataTable.length)
                                newIndex = tools.itemsInDataTable.length;
                              if (oldIndex < newIndex) newIndex--;
                              Future.delayed(Duration(milliseconds: 100), () {
                                setState(() {
                                  final item =
                                      tools.itemsInDataTable.removeAt(oldIndex);

                                  tools.itemsInDataTable.insert(newIndex, item);
                                });
                              });
                            }),
                      ),
